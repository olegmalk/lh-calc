...
class QueueManager extends events_1.EventEmitter {
    constructor(excelProcessor, customConfig) {
        super();
     ...
     */
    async processRequest(requestId, data) {
    ...
    async processWithWorker(worker, request) {
        ...
        try {
            ...
            worker.averageProcessingTime = this.updateAverage(worker.averageProcessingTime, processingTime, worker.processedCount);
            // Update global stats
