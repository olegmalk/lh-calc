 ...
 */
export declare const MATERIAL_CODES: readonly ["0000", "06ХН28МДТ", "09Г2С", "12Х18Н10Т", "20ХН3А", "30ХМА", "40Х"];
export declare const PRESSURE_RATINGS: readonly ["Ру6", "Ру10", "Ру16", "Ру25", "Ру40", "Ру63", "Ру100", "Ру160"];
export declare const DIAMETER_CODES: readonly ["Ду25", "Ду32", "Ду40", "Ду50", "Ду65", "Ду80", "Ду100", "Ду125", "Ду150", "Ду200", "Ду250", "Ду300", "Ду350", "Ду400", "Ду450", "Ду600", "Ду800", "Ду1000"];
export declare const THREAD_SPECS: readonly ["М16", "М18", "М20", "М22", "М24", "М27", "М30", "М33", "М36", "М39", "М42", "М48"];
export declare const SURFACE_TREATMENTS: readonly ["Zn-Cr 9мкм", "ст40Х"];
 ...
 */
export declare function isSuccessResponse(response: ApiResponse): response is CalculationResponse;
/**
 ...
 */
export declare function createErrorResponse(error: string, requestId: string, details?: ErrorDetails): ErrorResponse;
/**
 * Create standardized success response
 */
export declare function createSuccessResponse(results: CalculationResults, requestId: string, processingTimeMs: number, metadata?: {
    [key: string]: any;
}): CalculationResponse;
/**
 ...
 */
export declare function isValidMaterialCode(value: string): value is MaterialCode;
/**
 * Validate pressure rating
 */
export declare function isValidPressureRating(value: string): value is PressureRating;
/**
 * Validate diameter code
 */
export declare function isValidDiameterCode(value: string): value is DiameterCode;
/**
 * Validate thread specification
 */
export declare function isValidThreadSpec(value: string): value is ThreadSpec;
/**
 * Validate surface treatment
 */
export declare function isValidSurfaceTreatment(value: string): value is SurfaceTreatment;
/**
 * Equipment code pattern validator
 */
export declare function isValidEquipmentCode(value: string): boolean;
/**
 * Fraction pattern validator (e.g., "1/6")
 */
export declare function isValidFractionPattern(value: string): boolean;
/**
