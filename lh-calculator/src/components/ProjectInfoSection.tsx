...
import { IconCalendar, IconUser, IconId } from '@tabler/icons-react';
...
export const ProjectInfoSection: React.FC = () => {
  ...
  return (
    <Paper shadow="sm" p="lg" radius="md">
      <Group gap="xs" mb="md">
        <IconId size={20} />
        <Title order={4}>{t('form.sections.projectInfo')}</Title>
      </Group>
      ...
      <Grid>
        <Grid.Col span={{ base: 12, md: 6 }}>
          <TextInput
            ...
            onChange={(event) => updateInput('projectName', event.currentTarget.value)}
          />
        </Grid.Col>
        ...
        <Grid.Col span={{ base: 12, md: 6 }}>
          <TextInput
            ...
            onChange={(event) => updateInput('orderNumber', event.currentTarget.value)}
          />
        </Grid.Col>
        ...
        <Grid.Col span={{ base: 12, md: 6 }}>
          <TextInput
            ...
            onChange={(event) => updateInput('clientName', event.currentTarget.value)}
        ...
        <Grid.Col span={{ base: 12, md: 6 }}>
          <TextInput
            ...
            onChange={(event) => updateInput('deliveryDate', event.currentTarget.value)}
        ...
        <Grid.Col span={{ base: 12, md: 6 }}>
          <TextInput
            ...
            onChange={(event) => updateInput('projectManager', event.currentTarget.value)}
            leftSection={<IconUser size={16} />}
          />
        </Grid.Col>
        ...
        <Grid.Col span={{ base: 12, md: 6 }}>
          <TextInput
            ...
            onChange={(event) => updateInput('salesManager', event.currentTarget.value)}
            leftSection={<IconUser size={16} />}
          />
        </Grid.Col>
      </Grid>
